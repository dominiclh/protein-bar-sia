...
const flipIn = {
  ...
  animate: { rotateY: 0, opacity: 1, transition: { duration: 0.9, ease: [0.25, 0.46, 0.45, 0.94] } },
  exit:    { rotateY: -90, opacity: 0, transition: { duration: 0.7, ease: [0.55, 0.06, 0.68, 0.19] } },
};
